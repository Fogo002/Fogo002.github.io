          ...
          <ul>
            ...
            <li><strong>Valores:</strong> Nossa ação é pautada pelos seguintes valores fundamentais:
              <ul>
                ...
                <li><strong>Criatividade:</strong> Reconhecemos o poder transformador da arte e da expressão criativa como ferramentas para a mudança social e pessoal.</li>
                <li><strong>Colaboração:</strong> Valorizamos a colaboração e o trabalho em equipe como meios eficazes para alcançar nossos objetivos e ampliar nosso impacto na comunidade.</li>
                <li><strong>Compromisso:</strong> Mantemos-nos firmes em nosso compromisso de agir com integridade, dedicação e determinação em busca de um mundo mais inclusivo e justo para todos.</li>
              </ul>
            </li>
          </ul>
